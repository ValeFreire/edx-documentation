...
* For courses using content experiments, problem components in graded  subsections
  and grade exports are now supported. (TNL-41)
...
* In edX Insights, course authors will be able to view demographic   data for
  students enrolled in their courses. Self-reported age, education, and   gender
  data will be available to view as histograms, metrics, and in tables, and will
  also be available for download in csv format.
